...
import { Home, Zap, GraduationCap, User, Plus, MessageCircle, PenSquare } from 'lucide-react';
import { Post, Alert, StudyResource } from './types';

export const NAV_ITEMS = [
  { id: 'home', label: 'Home', icon: <Home size={22} /> },
  { id: 'funs', label: 'Funs', icon: <Zap size={22} /> },
  { id: 'create', label: 'Post', icon: <PenSquare size={22} /> },
  { id: 'chat', label: 'Live Chat', icon: <MessageCircle size={22} /> },
